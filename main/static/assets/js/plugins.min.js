...
function(a) {
    ...
    a.magnificPopup.registerModule(U, {
        ...
        var vid = $("#myvid");
        $(vid).attr("src", $("a.link:first").attr("href")), $("a.link:first").addClass("playing"), $("a.link").on("click", (function(event) {
            event.preventDefault(), $(vid).attr("src", $(this).attr("href")), $(".vids a").removeClass("playing"), $(this).addClass("playing"), $(".btnPlay").addClass("paused"), vid[0].play(), $("a.link:first").hasClass("playing") ? $(".prevvid").addClass("disabled") : $(".prevvid").removeClass("disabled"), $("a.link:last").hasClass("playing") ? $(".nextvid").addClass("disabled") : $(".nextvid").removeClass("disabled")
        ...
        })), vid.on("seeked", (function() {})), vid.on("waiting", (function() {
            $(".loading").fadeIn(200)
        })), vid.on("loadedmetadata", (function() {
            $(".current").text(timeFormat(0)), $(".duration").text(timeFormat(vid[0].duration)), vid[0].muted ? updateVolume(0, 0) : updateVolume(0, .7)
        }));
        ...
        vid.on("timeupdate", (function() {
            ...
            $(".timeBar").css("width", perc + "%"), $(".current").text(timeFormat(currentPos))
        ...
        var playpause = function() {
                vid[0].paused || vid[0].ended ? ($(".btnPlay").addClass("paused"), vid[0].play()) : ($(".btnPlay").removeClass("paused"), vid[0].pause())
            },
            timeDrag = !1;
        ...
        $(".sound").click((function() {
            vid[0].muted = !vid[0].muted, $(this).toggleClass("muted"), vid[0].muted ? $(".volumeBar").css("width", 0) : $(".volumeBar").css("width", 100 * vid[0].volume + "%")
        }));
        var volumeDrag = !1;
        $(".volume").on("mousedown", (function(e) {
            volumeDrag = !0, vid[0].muted = !1, $(".sound").removeClass("muted"), updateVolume(e.pageX)
        })), $(document).on("mouseup", (function(e) {
        ...
        var fastfowrd = function(obj, spd) {
            $(".speedcnt li").removeClass("selected"), $(obj).addClass("selected"), vid[0].playbackRate = spd, vid[0].play(), $("ul.speedcnt").fadeOut("fast"), $(".btnPlay").addClass("paused")
        };
        $(".btnspeed").click((function() {
            $("ul.speedcnt").slideToggle(100)
        })), $(".btnFS").on("click", (function() {
            $.isFunction(vid[0].webkitEnterFullscreen) ? vid[0].webkitEnterFullscreen() : $.isFunction(vid[0].mozRequestFullScreen) ? vid[0].mozRequestFullScreen() : alert("Your browsers doesn't support fullscreen")
        })), $(".btnLight").click((function() {
            $(this).toggleClass("lighton"), $(this).hasClass("lighton") ? $(".overlay").remove() : ($("body").append('<div class="overlay"></div>'), $(".overlay").css({
                position: "absolute",
                width: "100%",
            ...
            $(vid).attr("src", $(".playing").prev().attr("href")), vid[0].play(), $(".playing").prev().addClass("playing"), $(".playing:last").removeClass("playing"), $(".btnPlay").addClass("paused"), $(".nextvid").removeClass("disabled"), $("a.link:first").hasClass("playing") ? $(this).addClass("disabled") : $(this).removeClass("disabled")
        })), $(".nextvid").click((function() {
            $(vid).attr("src", $(".playing").next().attr("href")), vid[0].play(), $(".playing").next().addClass("playing"), $(".playing:first").removeClass("playing"), $(".btnPlay").addClass("paused"), $(".prevvid").removeClass("disabled"), $("a.link:last").hasClass("playing") ? $(this).addClass("disabled") : $(this).removeClass("disabled")
        }));
        var timeFormat = function(seconds) {
            var m = Math.floor(seconds / 60) < 10 ? "0" + Math.floor(seconds / 60) : Math.floor(seconds / 60),
                s;
            return m + ":" + (Math.floor(seconds - 60 * m) < 10 ? "0" + Math.floor(seconds - 60 * m) : Math.floor(seconds - 60 * m))
        };
        $(".closeme , .bigplay").click((function() {
            $("this,.ads,.bigplay").fadeOut(200), vid[0].play(), $(".btnPlay").addClass("paused")
        }))
    })),
    function(e) {
